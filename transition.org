...
*This chapter is very technical and dense. It is not necessary to absorb every detail to understand the big picture. This section serves as a comprehensive reference: a map of the cascading crises already in motion. Each thread — whether water, food, energy, waste, or social fabric — is a visible wound of a system unravelling under the weight of its disconnection from life.*

*** 1. Irreversible Damages: The Loss of Foundations
...
*** 2. Long Transition Struggles: Painful but Adaptable
...
*** 3. Surface Crises: Symptoms of Transition
