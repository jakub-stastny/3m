...
**** Mechanics of the global economy and hyperglobalisation
...
China took a different path. While it opened markets to global trade, it never fully surrendered control over capital or production. It used globalisation to strengthen the state, not dismantle it. Western leaders assumed that market integration would inevitably produce Western-style democracies. Instead, China proved that it was possible to exploit global capitalism without adopting its values — and today, it stands not as a disciple of the collapsing system, but as a rival shaping the post-collapse world.
...
The COVID-19 crisis exposed more than fragile supply chains. It revealed that most countries had gutted local production capacity in the name of efficiency, becoming dangerously dependent on distant factories. It showed that the just-in-time economic model — hailed as progress — collapses instantly under stress. It demonstrated how fiat currency can paper over collapse temporarily, but only by deepening the ultimate reckoning. Above all, it revealed that globalisation was never about resilience or solidarity. The moment crisis struck, borders slammed shut, nations hoarded resources, and trust in institutions crumbled. The empire was never a community — only a market.

The culture of modernity treated real production — farming, weaving, crafting — as backward or embarrassing. Children grew up thinking milk came from factories, not cows. Skills essential for life vanished, replaced by "bullshit jobs" managing illusions. When a civilisation forgets how to feed, clothe, and heal itself, collapse is not a question of if, but when.
